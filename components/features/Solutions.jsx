import { solutions, target } from "@/data/features";
      ...
      <div className="section-outer panel py-6 xl:py-9">
        <div className="container sm:max-w-lg xl:max-w-xl">
          <div className="section-inner panel">
            ...
            >
              <div className="text-center panel max-w-600px lg:max-w-700px xl:max-w-800px mx-auto">
                <h2 className="h3 sm:h2 lg:h1 xl:display-6">
                  The All-in-One{" "}
                ...
                <p className="fs-7 sm:fs-6 lg:fs-5 xl:fs-4 text-opacity-70 dark:text-white">
                  Our comprehensive tool suite gives you everything you need to
                  attract more local customers, manage your online presence, and
