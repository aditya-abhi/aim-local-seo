        ...
        <div className="container xl:max-w-xl">
          <div className="section-inner panel pt-0 lg:pt-4 xl:pt-0">
            <div className="row child-cols-12 justify-center items-center g-6 xl:g-8">
              <div>
                <div
                  className="panel vstack justify-center items-center max-w-600px lg:max-w-800px mx-auto px-2 lg:px-0 text-center"
                ...
                >
                  ...
                  <p className="fs-5 fw-bold xl:fs-4 text-black dark:text-white mt-4 d-none md:d-block">
                    Don't just compete on a national scale. Dominate your local
                    market.
                  </p>
                  <p className="fs-5 fw-bold xl:fs-4 text-black dark:text-white mb-4 d-none md:d-block">
                    Our powerful local SEO tool helps you attract nearby
                    customers by putting your business at the top of local
                    search results. Stop losing business to your competitors and
                    start driving targeted foot traffic to your door.
                  </p>
                  <Link
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      alt="app-dashboard"
                      src="/assets/images/template/local-seo-feature.webp"
                      width="1280"
                      height="853"
                    />
                  </div>
