import { features, solutionHome } from "@/data/features";
          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h1 m-0">
                The Problems Stop Here.{" "}
                <span className="text-tertiary dark:text-primary">
                  Your Solution is Waiting.
                </span>
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                No more lost customers or online headaches. Our powerful local
                SEO tool is ready to fix what's holding you back and get you on
                top.
              </p>
            </div>
            <div className="row child-cols-12 sm:child-cols-6 xl:child-cols-4 col-match justify-center g-2 lg:g-4">
              {solutionHome.map((feature, index) => (
                <div key={index}>
                  <div
