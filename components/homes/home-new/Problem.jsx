import { homeProblems, searchAnalytics } from "@/data/features";
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 xl:px-8 dark:text-white">
                You're working hard, but if you're not at the top of local
                search, you're missing out on customers every single day.
              </p>
            </div>
            <div
            ...
            >
              {homeProblems.map((feature, index) => (
