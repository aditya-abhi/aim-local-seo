                ...
                >
                  ...
                  <div className="panel overflow-hidden pt-9 z-2">
                    <Image
                      className=""
                      alt="Main hero image"
                      src="/assets/images/landing/hero-local-home.webp"
                      width="1600"
                      height="1176"
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      alt="hero-image"
                      data-anime="onscroll: .hero-scroll-scene; onscroll-offset: -300; onscroll-trigger: 0; onscroll-duration: 700%; translateY: [-24, 180];"
                      src="/assets/images/landing/side-2.webp"
                      width={845}
                      height={963}
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      src="/assets/images/landing/side-1.webp"
                      width={656}
                      height={818}
                    />
                  </div>
              ...
              <div className="col-12 sm:col-9 lg:col-5 order-0 lg:order-1 pt-9 lg:pt-4">
                ...
                >
                  ...
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                    Get found first, build trust fast, and convert more
                    customers with our automated tools and expert support.
                  </p>
