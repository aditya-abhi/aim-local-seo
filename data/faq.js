...
export const accordionFeaturesMain = [
  {
    id: 1,
    question: "What is local SEO, and why is it important for my business?",
    answer:
      "Local SEO is the process of optimizing your online presence to attract more business from local searches. It's crucial because it directly targets customers in your area who are ready to make a purchase, driving foot traffic and sales.",
    controls: "uc-accordion-24",
    expanded: true,
  },
  {
    id: 2,
    question: "How is your tool different from other SEO platforms?",
    answer:
      "Our platform focuses exclusively on local search dominance. We provide a tailored, weekly action plan and a comprehensive suite of AI-powered tools that go beyond basic rank tracking. We help you with everything from content creation and citation management to review responses, all designed to help you outrank local competitors and attract high-intent customers.",
    controls: "uc-accordion-26",
    expanded: false,
  },
  {
    id: 3,
    question: "Is your platform easy to use, even if I'm not an SEO expert?",
    answer:
      "Yes. Our platform is designed to be intuitive and easy to use. Our Smart Tasks feature gives you a personalized, step-by-step action plan, so you always know what to do next without having to guess or be an expert in SEO.",
    controls: "uc-accordion-28",
    expanded: false,
  },
  {
    id: 4,
    question: "Do you offer a free trial or a way to test the service?",
    answer:
      "We offer a free Local Rank Checker and LocalBusiness Schema Generator so you can see the value of our tools for yourself. You can also book a free demo call with our team to see how the full platform works before you commit.",
    controls: "uc-accordion-30",
    expanded: false,
  },
  {
    id: 5,
    question: "What kind of results can I expect to see?",
    answer:
      "You can expect to see increased visibility in Google's local search results, more customer actions like calls and directions, and an improved online reputation. Our Growth Statistics and real-time tracking features provide clear, measurable data so you can see the exact impact of your efforts.",
    controls: "uc-accordion-32",
    expanded: false,
  },
  {
    id: 6,
    question: "How does the AI Agent help me save time?",
    answer:
      "Our AI Agent acts as your personal SEO assistant. It handles time-consuming tasks like writing content for your Google Business Profile and drafting professional responses to customer reviews, freeing you up to focus on running your business.",
    controls: "uc-accordion-28",
    expanded: false,
  },
  {
    id: 7,
    question: "What if I already have a website? Can I still use your tools?",
    answer:
      "Absolutely. Our platform works seamlessly with your existing website. We provide tools like the LocalBusiness Schema Generator and Citations Manager to help improve your online listings and search visibility, whether or not you use our built-in website builder.",
    expanded: false,
  },
];
