...
export const servicePage1 = [
  {
    id: 1,
    imgSrc: "/assets/images/services/.webp",
    imgAlt: "Share tools quickly and confidently in minutes",
...
export const homeProblems = [
  {
    order: "order-1 lg:order-0",
    src: "/assets/images/custom-icons/competition.svg",
    alt: "feature-icon",
    title: "Your competition is already winning:",
    description:
      "They have more reviews and a better online presence, and you feel like you'll never catch up.",
  },
  {
    order: "order-0",
    src: "/assets/images/custom-icons/reputation.svg",
    alt: "feature-icon",
    title: "Your online reputation is slipping:",
    description:
      "You have a few very old, negative reviews and no new positive ones to balance them out.",
  },
  {
    order: "order-2 sm:order-1 lg:order-0",
    src: "/assets/images/custom-icons/invisible.svg",
    alt: "feature-icon",
    title: "You’re invisible on Google Maps:",
    description:
      "Your business is a ghost in the local search results, while your competition is showing up on top.",
  },
  {
    order: "order-1 lg:order-0",
    src: "/assets/images/custom-icons/losing.svg",
    alt: "feature-icon",
    title: "Your competition is already winning:",
    description:
      "They have more reviews and a better online presence, and you feel like you'll never catch up.",
...
export const solutionHome = [
  {
    id: 1,
    imgSrc: "/assets/images/template/guaranteed-visibility.webp",
    imgAlt: "Guaranteed Visibility",
    title: "Guaranteed Visibility",
    description:
      "We guide you to the top of Google Maps so customers find you before your competitors do.",
  },
  {
    id: 2,
    imgSrc: "/assets/images/template/a-reputation-that-sells.webp",
    imgAlt: "A Reputation That Sells",
    title: "A Reputation That Sells",
    description:
      "Automated review tools build trust fast with 5-star feedback that drives new customer growth. ",
  },
  {
    id: 3,
    imgSrc: "/assets/images/template/the-competitive-edge.webp",
    imgAlt: "The Competitive Edge",
    title: "The Competitive Edge",
    description:
      "See how you rank against rivals and use our strategy tools to win in your local market.",
  },
];
...
export const servicesHome = [
  {
    id: 1,
    imgSrc: "/assets/images/services/onboarding-&-setup.webp",
    imgAlt: "Step 1: Onboarding & Setup",
    title: "Step 1: Onboarding & Setup",
    description:
      "Simple kickoff process with tailored setup, ensuring your data and goals align from the start.",
  },
  {
    id: 2,
    imgSrc: "/assets/images/services/optimization-&-management.webp",
    imgAlt: "Step 2: Optimization & Management",
    title: "Step 2: Optimization & Management",
    description:
      "Ongoing campaign tuning and AI visibility updates, so performance keeps improving daily.",
    linkText: "View Service",
  },
  {
    id: 3,
    imgSrc: "/assets/images/services/reporting-&-results.webp",
    imgAlt: "Step 3: Reporting & Results",
    title: "Step 3: Reporting & Results",
    description:
      "Clear reports with actionable insights, showing exactly what drives growth and visibility.",
  },
  {
    id: 4,
    imgSrc: "/assets/images/services/interactive-growth-&-scaling.webp",
    imgAlt: "Step 4: Iterative Growth & Scaling",
    title: "Step 4: Iterative Growth & Scaling",
    description:
      "Continuous testing and smart scaling, helping your brand expand reach and ROI steadily.",
  },
];

export const featuresMain = [
  {
    src: "/assets/images/features/problem-1.webp",
    alt: "",
    title:
      "76% of nearby mobile searches lead to a business visit within 24 hours.",
  },
  {
    src: "/assets/images/features/problem-2.webp",
    alt: "",
    title:
      "62% of consumers steer clear of businesses with inaccurate online info.",
  },
  {
    src: "/assets/images/features/problem-3.webp",
    alt: "",
    title:
      "58% of businesses miss out by neglecting local search optimization.",
  },
  {
    src: "/assets/images/features/problem-4.webp",
    alt: "",
    title:
      "80% of Americans search locally weekly, with 78% making offline purchases.",
  },
];
...
export const mainFeature = [
  {
    order: "order-1 lg:order-0",
    iconSrc: "/assets/images/icons/35.svg",
    alt: "feature-icon",
    title: "Free Local Rank Checker",
    description:
      " See your business’s Google local rank and 3-Pack position for any keyword or location.",
  },
  {
    order: "order-0",
    iconSrc: "/assets/images/icons/36.svg",
    alt: "feature-icon",
    title: "Tracking",
    description:
      "Monitor keyword rankings, traffic, and SEO metrics to measure your local search performance over time.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-bottom-end-0 lg:rounded-bottom-0",
  },
  {
    order: "order-2 sm:order-1 lg:order-0",
    iconSrc: "/assets/images/icons/37.svg",
    alt: "feature-icon",
    title: "Audit",
    description:
      "Scan your site, GBP, and listings to uncover SEO issues and opportunities that affect your local rankings.",
  },
  {
    order: "order-1 lg:order-0",
    iconSrc: "/assets/images/icons/38.svg",
    alt: "feature-icon",
    title: "Research Mode",
    description:
      "Discover high-impact keywords, competitor strategies, and local trends to boost your SEO strategy.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-start-0 lg:rounded-top-end-0 lg:rounded-start-1-5",
  },
  {
    ...
    description:
      "View insights on visibility, reviews, and customer actions like calls and direction requests.",
  },
  {
    order: "order-2 lg:order-0",
    ...
    description:
      "Automate SEO tasks like review replies, GBP content, and monitoring with your AI-powered assistant.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-top-end-0 lg:rounded-top-start-0 lg:rounded-top-end-1-5",
  },
  {
    order: "order-1 lg:order-0",
    iconSrc: "/assets/images/icons/41.svg",
    alt: "feature-icon",
    title: "Smart Tasks",
    description:
      "Get weekly, personalized SEO tasks based on data, no guesswork, just clear steps to improve rankings.",
  },
  {
    order: "order-0",
    iconSrc: "/assets/images/icons/42.svg",
    alt: "feature-icon",
    title: "Schema Generator",
    description:
      "Create structured data code to help search engines understand your business and boost visibility.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-bottom-end-0 lg:rounded-bottom-0",
  },
  {
    order: "order-2 sm:order-1 lg:order-0",
    iconSrc: "/assets/images/icons/43.svg",
    alt: "feature-icon",
    title: "Content Publisher Updated",
    description:
      "Auto-publish GBP posts, offers, and events to keep your local audience engaged and informed.",
  },
  {
    order: "order-1 lg:order-0",
    iconSrc: "/assets/images/icons/44.svg",
    alt: "feature-icon",
    title: "Google Review Poster",
    description:
      "Generate a QR poster to make it easy for customers to leave reviews on your Google profile.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-start-0 lg:rounded-top-end-0 lg:rounded-start-1-5",
  },
  {
    order: "order-3 lg:order-0",
    iconSrc: "/assets/images/icons/45.svg",
    alt: "feature-icon",
    title: "Review Response Generator",
    description:
      "AI drafts quick, brand-consistent replies to both positive and negative reviews.",
  },
  {
    order: "order-2 lg:order-0",
    iconSrc: "/assets/images/icons/46.svg",
    alt: "feature-icon",
    title: "Review Manager Updated",
    description:
      "Track and respond to reviews across platforms with one dashboard and rating insights.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-top-end-0 lg:rounded-top-start-0 lg:rounded-top-end-1-5",
  },
  {
    order: "order-1 lg:order-0",
    iconSrc: "/assets/images/icons/47.svg",
    alt: "feature-icon",
    title: "Citations Manager",
    description:
      "Keep your business info consistent across directories to boost local search rankings.",
  },
  {
    order: "order-0",
    iconSrc: "/assets/images/icons/48.svg",
    alt: "feature-icon",
    title: "Website Builder",
    description:
      "Build a local SEO-friendly site with GBP tools, schema support, and contact integration.",
    bgClass:
      "bg-gradient-45 from-secondary to-transparent dark:from-gray-700 sm:rounded-bottom-end-0 lg:rounded-bottom-0",
  },
  {
    ...
    title: "Protection",
    description:
      "Guard your GBP from errors, spam, and changes to keep your business info accurate online.",
  },
];
...
export const solutions = [
  {
    ...
    description:
      "Take the guesswork out of local SEO. Our platform gives you a weekly, personalized action plan so your business profile stays accurate, up-to-date, and fully optimized to win more visibility in search.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    icon: "unicon-model",
    title: "Real-time Tracking & Audits",
    description:
      "You can’t improve what you don’t measure. Get clear, actionable data with real-time rank tracking and detailed audits of your business profile, so you always know where you stand and how to improve.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    icon: "unicon-task-approved",
    ...
    description:
      "Stay ahead in a crowded local market. Analyze your competitors’ strategies, uncover new growth opportunities, and protect your business profile from malicious edits or inaccurate changes",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    icon: "unicon-software",
    ...
    description:
      "Build the foundation of local visibility. Easily create engaging posts for your profiles and ensure your business information is consistent across all citations, boosting trust and search performance.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    icon: "unicon-building",
    ...
    description:
      "Turn reviews into growth opportunities. Manage all customer reviews from one place and draft perfect replies in seconds, showing professionalism and care while building trust with new customers.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    icon: "unicon-shopping-cart",
    ...
    description:
      "Go beyond listings with a strong digital hub. Our tool helps you build a locally optimized website and provides simple, clear reports so you can easily track progress and see measurable results.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
];
